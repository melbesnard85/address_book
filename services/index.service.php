...
$sel = mysqli_query($link,"select count(*) as allcount from contacts WHERE contacts.group_id in (". $group_ids . ")");
$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['allcount'];

## Total number of records with filtering
$sel = mysqli_query($link,"select count(*) as allcount from contacts WHERE contacts.group_id in (". $group_ids . ")".$searchQuery);
$records = mysqli_fetch_assoc($sel);
